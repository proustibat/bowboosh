...
module.exports = function ( gulp, plugins, config, pkg, bwr ) {
    ...
    gulp.task( 'build-js-classical-bis', 'Build javascript file from classical bis javascript sources', function () {
    ...
    gulp.task( 'watch-js-classical-bis', 'Watch classical javascript files bis', function () {
            config.env.dev = true;
            config.env.prod = false;
            plugins.runSequence(
                [ 'jscpd', 'jshint', 'build-js-classical-bis' ],
                function () {
                    plugins.tools.watch( config.srcPath + '/' + config.javascript.dir + '/' + config.javascript.subdir.classicalbis + '/**/*.js', [ 'jscpd', 'jshint', 'build-js-classical-bis' ] );
